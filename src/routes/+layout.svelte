...
<header>
    <div class="header-links">
        <a href={resolve("/")} class:active={page.url.pathname === resolve("/")}
            >Home</a
        >
        <a
            href={resolve("/about/")}
            class:active={page.url.pathname.startsWith(resolve("/about/"))}
            >About</a
        >
        <a
            href={resolve("/blog/")}
            class:active={page.url.pathname.startsWith(resolve("/blog/"))}
            >Blog</a
        >
        <a
            href={resolve("/diary/")}
