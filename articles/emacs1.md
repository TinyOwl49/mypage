...
### Org-mode がすごい
Org-mode は Markdown のようにプレーンテキストで文章の装飾をできるような記法なのですが、Markdown よりもだいぶ拡張性があります。  
...
ただ、どうしても限界があるらしく、あんまりモダンにできない部分もあるようです。
...
- 結局プログラミングをするときは慣れてる Neovim を使ってしまっています。
- Org Mode、奥が深過ぎてまだまだ使いこなせていないです。
